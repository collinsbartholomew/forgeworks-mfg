...
export default function MorePostsSection({ currentSlug }: MorePostsSectionProps) {
  ...
  return (
    <section className="section section-light">
      <div className="container">
        <h2 className="text-2xl lg-text-3xl font-heading font-medium text-center mb-10">
          More News
        </h2>
